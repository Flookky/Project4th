...
public class StudentAssignTrueFalseFragment extends Fragment implements RadioGroup.OnCheckedChangeListener, View.OnClickListener, LocationListener{
    private View view;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_assign_true_false_stu, container, false);
        ...
        if (getArguments() != null) {
            ...
            answerChoice = getArguments().getString("answertruefalse");
