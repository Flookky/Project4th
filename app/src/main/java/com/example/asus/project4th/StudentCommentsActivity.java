...
public class StudentCommentsActivity extends Activity {
    ...
    private static stuComment stuComment;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_comment_stu_inpost);
        initInstance();
        backToolbar();
        GetCommentFirebase();
    }
    ...
    private void initInstance() {
        ...
        stuComment = new stuComment(StudentCommentsActivity.this, listofUsername, listofComment, listofTime, listofimage, listoffile, listoffileUrl, new stuComment.OnItemClickListener() {
            @Override
            public void onItemClick(Comment comment) {
                Intent goComment = new Intent(StudentCommentsActivity.this,EachStuComment.class);
    ...
    private static void GetCommentFirebase(){
        ...
        ref.addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(@NonNull DataSnapshot dataSnapshot, @Nullable String s) {
                ...
                recyclerViewComment.setAdapter(stuComment);
            }
    ...
    public static class stuComment extends RecyclerView.Adapter<stuComment.StuCommentViewHolder>{
        ...
        public stuComment(Context context, List<Comment> Username, List<Comment> comment, List<Comment> time,
        ...
        @NonNull
        @Override
        public stuComment.StuCommentViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.list_comment_stu, parent, false);
            return new StuCommentViewHolder(v);
        }

        @Override
        public void onBindViewHolder(@NonNull stuComment.StuCommentViewHolder holder, final int position) {
        ...
        private void checkbeforeDelete(final String comment, final String time, final Context context){
            ...
            builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    ...
                    DatabaseReference ref = FirebaseDatabase.getInstance().getReference("Posts").child(subjectName).child("Post").child(nodekey);
        ...
        public class StuCommentViewHolder extends RecyclerView.ViewHolder {
            ...
            public StuCommentViewHolder(View itemView) {
                super(itemView);
